...
if not zip_link:
    raise ValueError("No ZIP file found with the specified class.")

# Step 3: Download the NHS ZIP file
nhs_zip_url = urljoin(nhs_url, zip_link)
nhs_zip_filename = nhs_zip_url.split('/')[-1]
download_file(nhs_zip_url, nhs_zip_filename)
...
files_to_zip = [nhs_zip_filename, epcn_filename, pcn_map_filename]
